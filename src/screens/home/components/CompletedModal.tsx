...
function CompletedCard({ item, onPress }: { item: MediaItem; onPress: () => void }) {
...
export function CompletedModal({ visible, movies, series, onClose }: Props) {
  return (
        ...
        <Pressable style={styles.sheet} onPress={() => {}}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {movies.length === 0 && series.length === 0 && (
              <Text style={styles.empty}>Nenhum item finalizado ainda.</Text>
            )}
          </ScrollView>
        </Pressable>
      </Pressable>
